...
const Contact = () => {
  return (
    <section
      id="contact"
      style={{ padding: "10rem 0", background: "var(--bg-surface)" }}
    >
        ...
        >
          ...
          >
            ...
            >
              ...
              >
                See how our products and services can accelerate your business
                growth. Book a personalized walkthrough today.
              </p>
              <div
                style={{
                  display: "flex",
              ...
              >
                <Zap size={16} /> Fast Track Booking &rarr;
              </div>
            </motion.div>
